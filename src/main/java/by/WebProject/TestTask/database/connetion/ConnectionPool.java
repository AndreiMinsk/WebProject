package by.WebProject.TestTask.database.connetion;
...
public final class ConnectionPool {
    ...
    public void initPoolData() {
        ...
        try {
            ...
            logger.error("CNF exception in connection pool");
        }
    }
    ...
    public Connection takeConnection() {
        ...
        try {
            ...
            logger.error("interrupted exception in connection pool");
        }
        return connection;
    }
    ...
    private class PooledConnection implements Connection{
        ...
        public void close() throws SQLException {
            ...
            if(!connectionQueue.offer(this)) throw new SQLException("Error allocating connection in the pool.");
